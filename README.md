...
| Team portraits & bios | `src/lib/content.ts` → `team`, `public/media/team-*.webp` | Aquilas Ali Baba (Managing Director, shown with the logo mark), Haoma Amoah (IT Director). Bios can still be tightened with their own words. |
